...
public final class FinalKit {
     ...
     * @return 返回格式化后的字符串
     */
    public static String getString(Context con, int rsId, Object... args) {
        MessageFormat mf = new MessageFormat(con.getResources().getText(rsId).toString());
    ...
    public static String getDiskCacheDir(Context context, String... folders) {
        return getDiskCacheFile(context,folders) + File.separator;
    }

    public static File getDiskCacheFile(Context context, String... folders) {
        String cacheRootPath = FinalKit.isExternalStorageRemovable() ? FinalKit.getExternalCacheDir(context).getPath()
     ...
     */
    public static void copyAssets(Context context, String srcFileName, String targetFileName) {
        try {
            InputStream myInput;
    ...
    private static SharedPreferences getSharedPreferences(Context con) {
        return con.getSharedPreferences(con.getPackageName(), con.MODE_PRIVATE);
    }
...
//    }
    ...
    public static void remove(Context con, String key) {
        SharedPreferences sharedPreferences = getSharedPreferences(con);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.remove(key);
        editor.commit();
    }
    ...
    public static boolean fetchBoolean(Context context, String key) {
        return fetchBoolean(context,key, false);
    }

    public static void putString(Context con, String key, String value) {
        Log.i("FinalKit",key+"  :  "+value);
        SharedPreferences sharedPreferences = getSharedPreferences(con);
        SharedPreferences.Editor editor = sharedPreferences.edit();
    ...
    public static String fetchString(Context context, String key) {
        return fetchString(context,key, null);
    }
    ...
    public static void putLong(Context context, String key, int value) {
        SharedPreferences sharedPreferences = getSharedPreferences(context);
        SharedPreferences.Editor editor = sharedPreferences.edit();
    ...
    public static int fetchInt(Context con, String key, int defaultValue) {
        return getSharedPreferences(con).getInt(key, defaultValue);
    }

    public static long fetchLong(Context context, String key, long defaultValue) {
        return getSharedPreferences(context).getLong(key, defaultValue);
    }

    public static int fetchInt(Context context, String key) {
        return fetchInt(context,key, 0);
    }
    ...
    public static Float fetchFloat(Context context, String key, float defaultValue) {
        return getSharedPreferences(context).getFloat(key, defaultValue);
    }

    public static Float fetchFloat(Context context, String key) {
        return fetchFloat(context,key, 0);
    }
    //==========================
    //使用Uri获取文件路径
    //==========================
    ...
    public static String getMetaValue(Context context, String metaKey) {
        ...
        try {
            ApplicationInfo ai = context.getPackageManager().getApplicationInfo(context.getApplicationContext().getPackageName(),
    ...
    public static boolean filter(String value) {
        for (char i : value.toCharArray()) {
            if (i == 32 || i == 34 || i == 35 || i == 60 || i == 62 || i == 92 || i == 94 || i == 96 || i == 123 || i == 124 || i == 125 || '/' == i || '\\' == i) {
                return true;
            }
        }
        return false;
